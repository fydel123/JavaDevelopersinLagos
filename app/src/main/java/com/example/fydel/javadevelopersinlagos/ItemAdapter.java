package com.example.fydel.javadevelopersinlagos;
...
import com.example.fydel.javadevelopersinlagos.controller.DeveloperDetails;
import com.example.fydel.javadevelopersinlagos.model.Item;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public ItemAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.developers_list, viewGroup, false);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(context, DeveloperDetails.class);
